...
func runIAM(ctx *cli.Context) error {
	...
	return embedgw.RunIAMAPI(ctx.Context, &embedgw.IAMConfig{
		...
		IAMEncryptionKeyDirectory:      gwcli.IAMEncryption.KeyDirectory,
		IAMEncryptionActiveKey:         gwcli.IAMEncryption.ActiveKey,
		IAMEncryptionKMSProvider:       gwcli.IAMEncryption.KMSProvider,
		IAMEncryptionKMSKeyID:          gwcli.IAMEncryption.KMSKeyID,
		IAMEncryptionKMSTimeout:        gwcli.IAMEncryption.KMSTimeout,
		IAMEncryptionRequired:          gwcli.IAMEncryption.RequireEncryption,
